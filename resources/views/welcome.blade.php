...
<body>
    ...
    <div class="container py-5">
        ...
        <form id="dzImageUploadForm" action="/upload" method="post" enctype="multipart/form-data">
            ...
            <button class="btn btn-lg btn-primary" id="dzSubmitButton">Upload Images</button>
        </form>
    ...
    <script id="dzTemplate" type="text/template">
        <div class="col-md-6 dz-image-preview" data-id="">
            <div class="dz-image position-relative rounded-3 overflow-hidden">
                ...
                <svg class="dz-remove-button m-2" type="button" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18 6l-12 12" /><path d="M6 6l12 12" /></svg>
            </div>
        </div>
    </script>    
    <script id="dzAdditionalTemplate" type="text/template">
        <div class="col-md-6">
            <div class="dz-additional-area text-muted position-relative form-control d-flex align-items-center justify-content-center">
                <svg class="dz-photo-icon opacity-75" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 8h.01" /><path d="M3 6a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v12a3 3 0 0 1 -3 3h-12a3 3 0 0 1 -3 -3v-12z" /><path d="M3 16l5 -5c.928 -.893 2.072 -.893 3 0l5 5" /><path d="M14 14l1 -1c.928 -.893 2.072 -.893 3 0l3 3" /></svg>
            </div>
        </div>
    </script>
